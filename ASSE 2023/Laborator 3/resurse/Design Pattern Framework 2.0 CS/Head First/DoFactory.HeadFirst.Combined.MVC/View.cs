...
namespace DoFactory.HeadFirst.Combined.MVC
{
    ...
    public class FormMain : System.Windows.Forms.Form
    {
        ...
        private void FormMain_Load(object sender, System.EventArgs e)
        {
            ...
            controller.Attach(this.textBoxCurrentBPM);
            controller.Attach(this.panelColor);
        }

        // Set and Start the beat
        private void buttonSet_Click(object sender, System.EventArgs e)
        {
            controller.BeatsPerMinute = int.Parse(textBoxBPM.Text);
            controller.Start();
        }
        ...
        {
            controller.BeatsPerMinute = this.trackBarBPM.Value;
